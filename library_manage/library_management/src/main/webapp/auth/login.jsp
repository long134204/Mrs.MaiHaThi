        ...
        <div class="row">
            <div class="col-12">
                <div class="mb-5">
                    ...
                    <p class="text-center m-0">Chưa có tài khoản? <a href="/auth/register.jsp">Đăng ký</a></p>
                </div>
            </div>
        </div>
...
&response_type=code
&client_id=63120300983-feiub696aah8rousbo5dosfcpg52ecse.apps.googleusercontent.com
&approval_prompt=force" class="btn btn-lg btn-danger">
                            ...
                            <a href="#!" class="btn btn-lg btn-dark">
                                ...
                                <span class="ms-2 fs-6">Đăng nhập bằng Apple</span>
                            </a>
                        </div>
                    </div>
                </div>
